...
export const work = [
  {
    ...
    responsibilities: [
      "Implement JANA's design system for company-wide usage",
      "Architect and publish a lean and modular React component library",
      "Contribute to the private microservices backend",
      "Collaborate with teams on an end-to-end deployment platform",
      "Work with authentication providers to bolster our security profile",
      "Assist the DevOps team to streamline CI/CD pipelines",
      "Automate source control tools to enforce code quality standards",
      "Maintain a well-document repository of code and internal resources",
      "Write unit and integration tests for front and back-end code",
      ...
      "Leverage proven development practices in an agile environment",
      "Pursue continuous learning and personal growth",
    ],
  },
  {
